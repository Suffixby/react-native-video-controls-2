...
//import course from '../../src/screens/course.js';
export default class VideoPlayer extends Component {
    ...
    componentWillReceiveProps(nextProps) {
       ...
       // console.log("nextProps - ", nextProps.paused);
    ...
    */
    ...
    renderPlayPause() {
        ...
        return this.renderControl(
            <Image resizeMode={'contain'} source={source} style={styles.controls.playPauseImage}/>,
        ...
        if (this.state.loading) {
            return(
              <View style={styles.loader.container}>
                  <View style={styles.loader.closeView}>
                    {this.renderBack()}
                  </View>
                  <View style={styles.loader.container}>
